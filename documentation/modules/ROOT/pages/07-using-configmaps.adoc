...
:navtitle: Configuration and Dependency Injection
:source-highlighter: rouge

image::07-01-configmap.png[Config Map]
...
image::07-02-complete.png[Active Application,width=350px]
...
image::07-03-pods.png[Pod details page]
...
image::07-04-testworks.png[Variables found,width=500px]
