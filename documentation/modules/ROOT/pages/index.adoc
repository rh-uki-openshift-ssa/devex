= Welcome to the OpenShift  Bootcamp
:!sectids:
...
Welcome to the OpenShift  Bootcamp. Over the next 2 days we will provide presentations, hands-on workshops and Q&A sessions to provide a structured introduction to container based applications running on the OpenShift platform from Red Hat.
